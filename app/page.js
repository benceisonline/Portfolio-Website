  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Bence Szabo - Software Engineering student with skills in project management, coding, QA, design, and theory. Explore team-based projects and work experience."
        />
        <meta
          name="keywords"
          content="Bence Szabo, Software Engineering, Project Management, Coding, QA, Design, Theory, React, Next.js, JavaScript, TypeScript, Java, MongoDB, Firebase"
        />
        <meta name="author" content="Bence Szabo" />
        <meta
          property="og:title"
          content="Bence Szabo - Software Engineering Student"
        />
        <meta
          property="og:description"
          content="Explore the skills, team-based projects, and work experience of Bence Szabo, a Software Engineering student."
        />
